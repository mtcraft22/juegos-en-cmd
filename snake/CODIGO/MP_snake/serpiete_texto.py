...
class MultiplayerSnake:
    '''
        ...
        3.-snakechar: Str(1)
        4.-beginchar: Str(1)
        Param set_snake_cords:
        Make tp on snake whit specifyed cords
        1.-Dest y cord: Int
        2.-Dest x cord: Int
        Param move snake:
        moves x slots in y and x cords
        1.-Add x slots to y cord: Int
        2.-Add x slots to x cord: Int
        Set_food is a encasulated method don't use
    '''
